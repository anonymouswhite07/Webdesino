  ...
  const services = [
    {
      ...
      description:
        "Elevate your online presence with our web development agency in Delhi. We create visually stunning, user-friendly websites that capture your brand's essence and deliver captivating digital experiences",
      icon: "💻",
    },
    {
      title: "SEO Optimization Agency",
      description:
        "Boost your visibility with our expert SEO strategies. As a top SEO optimization agency in Delhi, we help your website rank higher, driving organic traffic and sustainable growth",
      icon: "🔍",
    },
    {
      title: "Digital Marketing Agency",
      description:
        "Unlock growth with Delhi's top digital marketing agency, using SEO, social media, and targeted campaigns to boost your brand and deliver real results",
      icon: "📈",
    },
  ];
