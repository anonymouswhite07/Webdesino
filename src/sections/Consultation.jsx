    ...
    <section className="c-space section-spacing">
      <div className="bg-gradient-to-r from-primary/30 to-secondary/30 p-10 rounded-2xl border border-white/10 text-center">
        ...
        <p className="text-xl text-neutral-300 mb-8 max-w-3xl mx-auto">
          At WebDesino, we help businesses in Delhi NCR and across India achieve higher Google rankings, more leads, and better conversions. Book your free consultation or request a website audit today to discover how we can transform your digital presence.
        </p>
        ...
        <div className="max-w-2xl mx-auto bg-primary/20 p-6 rounded-xl border border-white/10">
          ...
          <p className="text-neutral-400 mt-4 text-sm">
            Enter your website URL below and get an instant SEO analysis including speed, meta tags, mobile optimization, and ranking opportunities. This free SEO audit helps businesses across Delhi NCR & India identify growth opportunities.
          </p>
        </div>
      </div>
    </section>
