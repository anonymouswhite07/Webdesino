  ...
  const features = [
    {
      ...
      description: "Trusted by businesses across Delhi NCR with measurable growth in traffic, leads, and sales."
    },
    {
    ...
    },
    {
      ...
      description: "Our SEO-first approach ensures your business ranks on top of Google searches in Delhi NCR."
    },
    {
  ...
  return (
    <section className="c-space section-spacing">
      <div className="text-center mb-16">
        <h2 className="text-heading">Why Choose WebDesino as Your Web Development Company in Delhi?</h2>
        <p className="mt-4 text-xl text-neutral-400 max-w-3xl mx-auto">
          At WebDesino, we deliver professional web development and digital marketing solutions that help businesses in Delhi NCR grow faster. With SEO-optimized websites, timely delivery, and award-winning strategies, we ensure your online presence stands out in a competitive market.
        </p>
      </div>
