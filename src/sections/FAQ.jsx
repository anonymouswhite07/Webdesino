  ...
  const faqs = [
    {
      ...
      answer: "WebDesino combines technical expertise with deep local market knowledge to deliver websites that not only look great but also rank well on Google. Our data-driven approach, proven results, and commitment to client success set us apart."
    },
    {
      question: "Do you provide local SEO services for areas like Uttam Nagar, Karol Bagh, Kamla Nagar, and Krishan Vihar?",
      answer: "Yes, we specialize in hyperlocal SEO for businesses across Delhi NCR. Our local SEO strategies help businesses rank in neighborhood-specific searches, driving real foot traffic and leads."
    },
    {
    ...
    {
      question: "Does WebDesino also handle digital marketing campaigns in Delhi NCR?",
      answer: "Absolutely. We offer comprehensive digital marketing services including Google Ads, social media marketing, content marketing, and email campaigns tailored for the Delhi NCR market."
    },
    {
      question: "What industries does WebDesino specialize in for website development and SEO?",
    ...
    },
    {
      ...
      answer: "Yes, we've helped multiple e-commerce businesses in Delhi NCR increase their online sales by 300-500%. Our approach combines technical SEO, conversion rate optimization, and targeted digital marketing."
    },
    {
    ...
    {
      question: "Why is local SEO important for businesses in Delhi NCR?",
      answer: "Local SEO helps businesses appear in 'near me' searches and Google Maps results. For Delhi NCR businesses, this is crucial as most customers search locally. We optimize for local keywords, citations, and Google Business profiles."
    },
    {
      question: "How can I get started with WebDesino's web development or SEO services?",
