  ...
  return (
    <section className="c-space section-spacing">
      <div className="text-center mb-16">
        <h2 className="text-heading">Service Areas Across Delhi NCR</h2>
        <p className="mt-4 text-xl text-neutral-400">
          At WebDesino, we proudly serve businesses in:
        </p>
      </div>
      ...
      <div className="bg-primary/20 rounded-2xl border border-white/10 p-8 text-center">
        <div className="bg-gray-200 border-2 border-dashed rounded-xl w-full h-96 flex items-center justify-center">
          <p className="text-neutral-400 text-xl">
            ...
            <span className="text-sm">Interactive map showing our service areas across Delhi NCR</span>
          </p>
        </div>
